...
var httpClient = &http.Client{
	Transport: &http.Transport{
		// Enable connection reuse by using Keep-Alive
		MaxIdleConns:    10, // The maximum number of idle connections
		IdleConnTimeout: -1, // Keep connections alive for 30 seconds after use
	},
}
...
func (a *NFInstanceIDDocumentApiService) RegisterNFInstance(ctx context.Context, nfInstanceID string, nfProfile models.NfProfile, cert string, key string) (models.NfProfile, *http.Response, error) {
	var (
